...
from repository.text_repo import Repository
...
class TestPersonMethods(unittest.TestCase):
    ...
    def test_list(self):
        self.assertTrue(
            re.search("_Person__pers_id=10, _Person__name='Rick Astley', _Person__phone_number='0740129812'",
                      str(self.service.p_all())))
        self.assertIsNone(re.search("_Person__pers_id=11", str(self.service.p_all())))

        self.repo = Repository()
        self.assertTrue(re.search("_Person__pers_id=10, _Person__name='Rick Astley', _Person__phone_number='0740129812'", str(self.repo.p_storage())))
    ...
    def test_add(self):
        ...
        self.assertTrue(self.repo._persons[0].pers_id == 1)
        self.assertTrue(self.repo._persons[0].name == 'Name')
        self.assertTrue(self.repo._persons[0].phone_number == '0740219821')
    ...
    def test_update(self):
        ...
        if self.repo._persons[0].name != 'Name2' or self.repo._persons[0].phone_number != '0700000000':
    ...
    def test_remove(self):
        ...
        self.repo.p_remove(1)
        self.assertTrue(self.repo._persons == [])
...
class TestActivityMethods(unittest.TestCase):
    def setUp(self):
        self.service = Service()
        self.repo = Repository()
        self.repo._activities = []

    def test_list(self):
        self.assertTrue(re.search(", _Activity__date='23/8/2020', _Activity__time='12/13', _Activity__desc='rickrolling'", str(self.service.a_all())))
        self.assertTrue(re.search('_Activity__act_id=10, _Activity__pers_list=', str(self.service.a_all())))
        self.assertIsNone(re.search("_Activity__act_id=11", str(self.service.a_all())))

        self.repo = Repository()
        self.assertTrue(re.search(", _Activity__date='23/8/2020', _Activity__time='12/13', _Activity__desc='rickrolling'", str(self.repo.a_storage())))
        self.assertTrue(re.search("_Activity__act_id=10, _Activity__pers_list=", str(self.repo.a_storage())))
        self.assertIsNone(re.search("_Activity__act_id=11", str(self.repo.a_storage())))

    def test_add(self):
        self.repo.p_add(1, 'Name', '0740219821')
        self.repo.a_add(1, [1], '11/11/2020', '11/12', 'desc')
        self.service.a_add(11, [1], '11/11/2020', '11/12', 'desc')
        self.assertTrue(self.repo._activities[0].act_id == 1)
        self.assertTrue(self.repo._activities[0].act_pers_list == [1])
        self.assertTrue(self.repo._activities[0].date == '11/11/2020')
        self.assertTrue(self.repo._activities[0].time == '11/12')
        self.assertTrue(self.repo._activities[0].desc == 'desc')
    ...
    def test_update(self):
        ...
        if self.repo._activities[0].date != '6/7/2021' or \
                self.repo._activities[0].time != '1/2' or \
                self.repo._activities[0].desc != 'desc2':
...
class TestOtherMethods(unittest.TestCase):
    ...
    def test_act_sort(self):
        ...
        self.assertTrue(re.search("_Activity__act_id=10", str(self.service.a_sort_time())))
        self.assertTrue(re.search("_Activity__pers_list=", str(self.service.a_sort_time())))
        self.assertTrue(re.search("_Activity__time='12/13'", str(self.service.a_sort_time())))
        self.assertTrue(re.search("_Activity__desc='rickrolling'", str(self.service.a_sort_time())))
    ...
    def test_act_person(self):
        ...
        self.assertRaises(ValueError, self.service.a_person, '11')
...
class TestHistory(unittest.TestCase):
    ...
    def test_persons(self):
        ...
        self.service.p_update(11, 'Name', '0740219821')
        self.service.undo()
        self.service.undo()
        self.service.undo()
        self.assertRaises(ValueError, self.service.undo)
